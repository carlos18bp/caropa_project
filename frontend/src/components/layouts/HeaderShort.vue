        ...
        <header class="bg-white h-16 flex items-center px-8 py-2 w-full">
            ...
            <div class="grow flex justify-evenly items-center">
                ...
                class="flex-1 flex justify-center items-center">
                    <a
                        class="inline-block font-famil-semibold text-lg uppercase text-center"
                        :class="{
                ...
                <div v-for="category in categories.slice(5, 10)" :key="category.id"
                @click="filterProducts(category)" 
                class="flex-1 flex justify-center items-center">
                    <a
                        class="inline-block font-famil-semibold text-lg uppercase text-center"
            ...
            <div class="flex items-center justify-end gap-6">
                <MagnifyingGlassIcon @click="showSearchBar = true" class="text-black size-6 cursor-pointer"></MagnifyingGlassIcon>
