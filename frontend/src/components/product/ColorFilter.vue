  ...
  <div>
    ...
    <Disclosure defaultOpen>
      <template #default="{ open }">
        ...
        <!-- Disclosure Button -->
        <DisclosureButton class="flex justify-between w-full px-4 py-2 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100">
          ...
          <div class="grid grid-cols-3 gap-4">
            ...
            >
              ...
              >
                ...
                <img 
                  v-if="colorsSelected.includes(color) && color !== 'white'" 
                  src="@/assets/images/product/checked_white.png" 
                  alt="checked" 
                  class="absolute size-3"
                />
                <img 
                  v-if="colorsSelected.includes(color) && color === 'white'" 
                  src="@/assets/images/product/checked_black.png" 
                  alt="checked" 
                  class="absolute size-3"
                />
              </button>
...
<script setup>
  ...
  /**
   * Initializes the product store and defines computed properties and functions.
   */
