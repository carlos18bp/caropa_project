  ...
  <div>
    ...
    <section class="px-72 py-16">
      <div class="grid grid-cols-2 gap-4">
        <div
          v-for="(category, index) in home_categories.slice(0, 2)"
          :key="category.id"
        >
          <div>
          ...
          <div class="flex justify-center pt-6">
            <img
              class="w-full"
              :src="category.image"
              :alt="'Image from Caropa Couture about ' + category.title"
            />
          </div>
        </div>
      </div>
    ...
    <section class="px-72 py-16">
      ...
      <div class="mt-16 grid grid-cols-3 gap-4">
        <div
          v-for="(category, index) in home_categories.slice(2, 8)"
          :key="category.id"
        >
    ...
    <section v-if="home" class="px-72 py-16 grid grid-cols-2">
      ...
      >
        <swiper-slide
          class="flex justify-center items-center"
          v-for="image in home.section_3_gallery_urls"
        >
          <img class="block w-full h-full object-cover" :src="image" />
        </swiper-slide>
      </swiper>
    ...
    <section class="px-72 py-16">
      <div class="grid grid-cols-2 gap-4">
        <div
          v-for="(category, index) in home_categories.slice(8, 12)"
          :key="category.id"
        >
          <div>
